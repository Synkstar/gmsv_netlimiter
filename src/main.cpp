...
namespace global {
	...
	static void Initialize(GarrysMod::Lua::ILuaBase *LUA) {
		...
		global::lua->PushSpecial(GarrysMod::Lua::SPECIAL_GLOB);
		global::lua->GetField(-1, "CreateConVar");
		global::lua->PushString("net_chan_limit_msec");
		global::lua->PushNumber(0);
		global::lua->PushNumber(FCVAR_REPLICATED);
		global::lua->PushString("Sets the maximum amount of time, in milliseconds, that the server will allow a client to spend processing their network messages. If a client exceeds this time, they will be disconnected. Set to 0 to disable.");
		global::lua->Call(4, 0);
		global::lua->Pop();
